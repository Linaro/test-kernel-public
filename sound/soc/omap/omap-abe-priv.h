...
#define MIX_DL1_TONES		OMAP_ABE_MIXER(0)
#define MIX_DL1_VOICE		OMAP_ABE_MIXER(1)
#define MIX_DL1_CAPTURE		OMAP_ABE_MIXER(2)
#define MIX_DL1_MEDIA		OMAP_ABE_MIXER(3)
#define MIX_DL2_TONES		OMAP_ABE_MIXER(4)
#define MIX_DL2_VOICE		OMAP_ABE_MIXER(5)
#define MIX_DL2_CAPTURE		OMAP_ABE_MIXER(6)
#define MIX_DL2_MEDIA		OMAP_ABE_MIXER(7)
#define MIX_AUDUL_TONES		OMAP_ABE_MIXER(8)
#define MIX_AUDUL_MEDIA		OMAP_ABE_MIXER(9)
#define MIX_AUDUL_CAPTURE		OMAP_ABE_MIXER(10)
#define MIX_VXREC_TONES		OMAP_ABE_MIXER(11)
#define MIX_VXREC_VOICE_PLAYBACK		OMAP_ABE_MIXER(12)
#define MIX_VXREC_VOICE_CAPTURE		OMAP_ABE_MIXER(13)
#define MIX_VXREC_MEDIA		OMAP_ABE_MIXER(14)
#define MIX_SDT_CAPTURE		OMAP_ABE_MIXER(15)
#define MIX_SDT_PLAYBACK		OMAP_ABE_MIXER(16)
#define MIX_SWITCH_PDM_DL		OMAP_ABE_MIXER(17)
#define MIX_SWITCH_BT_VX_DL		OMAP_ABE_MIXER(18)
#define MIX_SWITCH_MM_EXT_DL		OMAP_ABE_MIXER(19)
#define MIX_DL1_MONO		OMAP_ABE_MIXER(20)
#define MIX_DL2_MONO		OMAP_ABE_MIXER(21)
#define MIX_AUDUL_MONO		OMAP_ABE_MIXER(22)

#define OMAP_ABE_NUM_MONO_MIXERS	(MIX_AUDUL_MONO - MIX_DL1_MONO + 1)
#define OMAP_ABE_NUM_MIXERS		(MIX_AUDUL_MONO + 1)

#define OMAP_ABE_MUX(x)		(x + OMAP_ABE_NUM_MIXERS)
...
#define OMAP_ABE_VIRTUAL_SWITCH	0
