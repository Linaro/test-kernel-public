...
#define IOCTL_SET_DEC_IN_BUF			_IO(JPEG_IOCTL_MAGIC, 7)
#define IOCTL_SET_DEC_OUT_BUF			_IO(JPEG_IOCTL_MAGIC, 8)
#define IOCTL_SET_ENC_IN_BUF			_IO(JPEG_IOCTL_MAGIC, 9)
#define IOCTL_SET_ENC_OUT_BUF			_IO(JPEG_IOCTL_MAGIC, 10)
#define IOCTL_SET_DEC_PARAM			_IO(JPEG_IOCTL_MAGIC, 11)
#define IOCTL_SET_ENC_PARAM			_IO(JPEG_IOCTL_MAGIC, 12)
